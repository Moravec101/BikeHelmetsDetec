...
video_file_path = r"C:\Users\marc_\Desktop\YOLO8\Videos\f6.mp4"
output_file_path = r"C:\Users\marc_\Desktop\YOLOcount.mp4"
        ...
        for box in boxes:
            ...
            if conf > 0.6 and currentClass == 'with-helmet'or currentClass == 'without-helmet' :
                ...
                cvzone.putTextRect(img, f'{currentClass} {conf}',
                                (text_x, text_y), scale=1.3, thickness=1, colorB=myColor,
